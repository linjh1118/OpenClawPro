...
- `skill-creator` — After installing skills via clawhub, users often use skill-creator to modify or create new skills based on installed examples

**Downstream Dependents:** None

This skill provides skill discovery and installation capabilities. It works well with skill-creator for a complete skill management workflow.
