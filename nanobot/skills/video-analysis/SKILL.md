...
- `summarize` — Can use summarize as a fallback for quick video transcription when the full video-analysis workflow is not needed

**Downstream Dependents:** None

This skill provides comprehensive video analysis capabilities. For quick transcription tasks, the summarize skill can be used as a lightweight alternative.
