...
- `memory` — The skill-creator references memory patterns for storing important facts about skill development progress and user preferences
- `clawhub` — Users can discover and install existing skills via clawhub, then use skill-creator to modify or create new skills based on those examples

**Downstream Dependents:**
- `clawhub` — After creating skills with skill-creator, users may publish them to clawhub for distribution

This skill depends on `memory` for best practices around storing facts during skill creation, and integrates with `clawhub` for a complete skill lifecycle (discover, install, create, publish).
