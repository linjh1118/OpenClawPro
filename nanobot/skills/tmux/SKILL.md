...
This skill is a standalone utility for managing interactive terminal sessions. It can be used independently to orchestrate multiple CLI tools and coding agents.
